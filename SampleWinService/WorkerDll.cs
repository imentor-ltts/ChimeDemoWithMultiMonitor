...
using Logger = ChimeAppLauncherWinService.Logger;

namespace SampleWinService;

internal class WorkerDll : BackgroundService
{
    private readonly ILogger<WorkerDll> _logger;
    ...
    public WorkerDll(ILogger<WorkerDll> logger, ChimeLauncher launcher, IConfiguration configuration, IOptions<CommandLineArgs> commandLineArgs)
    {
        _chime = launcher;
        _logger = logger;
    ...
    /// <summary>
    /// Called when the service Starts either by SCM or Services Console. 
    /// </summary>
