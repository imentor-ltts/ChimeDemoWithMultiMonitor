...
using System.Text;
using static ChimeAppLauncherWinService.Win32Apis.ADVAPI32;
using static ChimeAppLauncherWinService.Win32Apis.User32;

namespace ChimeAppLauncherWinService.Win32Apis
{
    ...
    public class Win32Interop
    {
        ...
        public static string GetUsernameFromSessionId(uint sessionId)
        {
            ...
            if (WTSAPI32.WTSQuerySessionInformation(0, sessionId, WTSAPI32.WTS_INFO_CLASS.WTSUserName, out var buffer, out var strLen) && strLen > 1)
            {
         ...
         out PROCESS_INFORMATION procInfo)
        {
            ...
            hProcess = (int)Kernel32.OpenProcess(MAXIMUM_ALLOWED, true, winlogonPid);
            ...
            if (!result)
            {
                ...
                Console.WriteLine("Failed to create process. Error code: " + error);
            }
