...
namespace RemoteSessionApi.Services
{
public class ApplicationLoader
{
    ...
    public static bool StartProcessAndBypassUAC(String applicationName)
    {
        ...
        var result = CreateProcessAsUser(hUserTokenDup, applicationName, "801445", ref sa, ref sa, false, dwCreationFlags, IntPtr.Zero, null, ref si, out procInfo);
